		...
		<div class="row m-0">
			...
			<div class="main_section col-12 col-md-8 col-lg-9 p-0">
				...
				<div class="col-12 d-flex flex-column align-items-center">
					<?php 
						 $categories3 = get_categories($link,"community");
					?>
					<h1><?php echo $categories3[$_COOKIE['community_id']-1]['name_community']?></h1> 
					
					<div class="wrapper p-3 mx-5 my-1 col-12 col-md-8">
						<div class="row">
							<form method="POST" action="add_news_community.php" class="d-flex flex-column col-12">
								<div class="d-flex">
					...
					<?php foreach ($categories as $news): ?>
						<?php if ($news['community_id']==$_COOKIE['community_id']):?>
						<div class="wrapper p-3 mx-5 my-1 col-12 col-md-8">
							<div class="row">
